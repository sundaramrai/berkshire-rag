...
import { OLLAMA_CHAT_MODEL, OLLAMA_EMBEDDING_MODEL } from "@/lib/ollama-provider";
...
export const LETTER_EMBEDDING_MODEL = OLLAMA_EMBEDDING_MODEL;
export const LETTER_RESPONSE_MODEL = OLLAMA_CHAT_MODEL;
